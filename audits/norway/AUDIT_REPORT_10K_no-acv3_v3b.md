# Norsk modellrevisjon — `Abyssal/intent-classifier-general-no-acv3:1.5b`

- 10008 reelle API-kall, temperatur 0, `no/output/results_no_10k_v3b.csv`
...
|---|---|---|---|---|---|---|
| exact | free | 36 | 100.0% | 100.0% | 100.0% | 468 |
| exact | enum | 36 | 100.0% | 100.0% | 100.0% | 468 |
| native_in_random | free | 1880 | 99.5% | 100.0% | 100.0% | 504 |
| native_in_random | enum | 1880 | 99.5% | 100.0% | 100.0% | 516 |
| native_in_nearsyn | free | 745 | 99.5% | 100.0% | 100.0% | 512 |
| native_in_nearsyn | enum | 745 | 99.6% | 100.0% | 100.0% | 514 |
| native_out | free | 926 | 0.0% | 100.0% | 100.0% | 512 |
| custom_in | free | 1880 | 99.5% | 100.0% | 100.0% | 492 |
| custom_in | enum | 1880 | 99.4% | 100.0% | 100.0% | 517 |

## Porter (gates)

- exact free = 100: 100.0% → **BESTÅTT**
- inscope >= 94: 99.5% → **BESTÅTT**
- nearsyn free >= 94: 99.5% → **BESTÅTT**
- custom free >= 88: 99.5% → **BESTÅTT**
...
- enum: 99.6% topp-1, 100.0% i liste.

Feil i fri generering (gold → valgt): `gruppetime`→`book_time` x2, `bestillingsstatus_mat`→`sporing_mat` x2
...
| `bestillingsstatus_mat` | 71% (n=7) | 100% | 86% (n=7) | 100% |
...
| `gruppetime` | 71% (n=7) | 100% | 71% (n=7) | 100% |
...
| `konsertbillett` | 100% (n=7) | 100% | 100% (n=7) | 100% |
...
- fri: 99.5% topp-1, 100.0% i liste.
- enum: 99.4% topp-1, 100.0% i liste.
...
| `ehandel` | 99.7% | 100.0% | 707 |
| `forsikring` | 99.2% | 100.0% | 265 |
| `jobb` | 100.0% | 100.0% | 237 |
| `konto` | 99.6% | 100.0% | 268 |
| `matlevering` | 98.3% | 100.0% | 233 |
| `offentlig` | 99.7% | 100.0% | 292 |
| `reise` | 98.8% | 100.0% | 337 |
| `restaurant` | 100.0% | 100.0% | 377 |
| `sosiale_medier` | 100.0% | 100.0% | 180 |
| `strom` | 98.9% | 100.0% | 185 |
| `telekom` | 100.0% | 100.0% | 266 |
| `trening` | 97.7% | 100.0% | 266 |
| `underholdning` | 100.0% | 100.0% | 208 |
...
| `bestillingsstatus_mat` | 86% (n=14) | 100% | 86% (n=14) | 100% |
...
| `bilforsikring` | 94% (n=16) | 100% | 94% (n=16) | 100% |
...
| `dekning_forsikring` | 100% (n=22) | 100% | 100% (n=22) | 100% |
...
| `gruppetime` | 86% (n=14) | 100% | 86% (n=14) | 100% |
...
| `leiebil` | 93% (n=14) | 100% | 93% (n=14) | 100% |
...
| `skatteoppgjor` | 93% (n=14) | 100% | 93% (n=14) | 100% |
...
- 2x  bestillingsstatus_mat <- sporing_mat
- 1x  leiebil <- hotell
- 1x  skatteoppgjor <- skatteutbetaling
- 1x  bilforsikring <- dekning_forsikring

## Latens

- exact/free: median 468 ms (N=36)
- exact/enum: median 468 ms (N=36)
- native_in_random/free: median 504 ms (N=1880)
- native_in_random/enum: median 516 ms (N=1880)
- native_in_nearsyn/free: median 512 ms (N=745)
- native_in_nearsyn/enum: median 514 ms (N=745)
- native_out/free: median 512 ms (N=926)
- custom_in/free: median 492 ms (N=1880)
- custom_in/enum: median 517 ms (N=1880)
- snitt output-tokens: 5.8, totalt 57927
...
- **taksonomiens egne navn (gold tilbudt)**: fri generering 99.5% treff / 100.0% i liste; enum 99.5% treff / 100.0% i liste.
- **listeer med nær-synonym-felle**: fri generering 99.5% treff / 100.0% i liste; enum 99.6% treff / 100.0% i liste.
- **oppfunnede/egne intent-navn**: fri generering 99.5% treff / 100.0% i liste; enum 99.4% treff / 100.0% i liste.
